...
<style>
    #background {
        background-image: linear-gradient(to right, #cf5e17, #9c4236);
...
<div class="container my-3">
    <h2 class="text-center font-italic"> Th10 Bases </h2>
    <hr style="background: #000; height:1px; width:50%" class="my-4">
    
    <div class="p-4">
        <h5 class="font-italic ml-2"> Click to Upload Your own Base. </h5>
        <a class="btn btn-info btn-block font-weight-bold p-2 mt-3 mx-auto" href="baseHandle.php?th10id=true">Click to upload
        </a>
...
<div class="container  " id="background">
    <div class="row">
        ...
        $sql = "SELECT * FROM `th10` ORDER BY imageId DESC";
